...
- [.github/workflows/](./.github/workflows/) holds the CI and release pipelines, with `validate-task.yml` as the single validation gate that the pull request check and the release both call.
